#!/usr/bin/env python
# This script is for photos-controller save API
# Author: Rui Li
# Input: params
...
def photosCreate(params):
    ...
    if code != 200:
        ...
        writeToLog(params['logFile'], stepName, 'INFO', 'Photo ID ' + str(response_body['id']) + ' created for album ' + str(response_body['albumId']))
