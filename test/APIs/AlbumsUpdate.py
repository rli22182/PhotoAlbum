#!/usr/bin/env python
# This script is for albums-controller update API
# Author: Rui Li
# Input: params
...
def albumsUpdate(params):
    ...
    if code != 200:
        ...
        writeToLog(params['logFile'], stepName, 'INFO', 'Album ID ' + str(response_body['id']) + ' updated for user ' + str(response_body['userId']))
