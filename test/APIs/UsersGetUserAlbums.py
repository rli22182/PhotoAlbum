#!/usr/bin/env python
# This script is for users-controller getUserAlbums API
# Author: Rui Li
# Input: params
...
def usersGetUserAlbums(params):
    ...
    if code != 200:
        ...
        writeToLog(params['logFile'], stepName, 'INFO', 'User ' + str(params['id']) + ' has ' + str(total_albums) + ' albums.')
